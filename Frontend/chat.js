document.addEventListener("DOMContentLoaded", function () {
    ...
    const clothesVisualizerContent = document.getElementById("clothesVisualizerContent");
    ...
    saveButton.addEventListener("click", function () {
        ...
        if (promptText) {
            const imageUrl = "https://res.cloudinary.com/dhhax6yae/image/upload/v1692253401/undraw_Fashion_blogging_re_fhi5_fxxa0i.png";
